...
const CATALOG = [
  ...
  },
  {
    ...
    color: '#22A06B',
    items: [
      { id: 'hp|基础|血常规',          parent: '基础健康检查', label: '血常规',          gender: null },
      { id: 'hp|基础|电解质',          parent: '基础健康检查', label: '电解质',          gender: null },
      { id: 'hp|基础|25羟基维生素D',   parent: '基础健康检查', label: '25-羟基维生素D',  gender: null },
      { id: 'hp|基础|凝血功能',        parent: '基础健康检查', label: '凝血功能',        gender: null },
      { id: 'hp|基础|D二聚体',         parent: '基础健康检查', label: 'D-二聚体',        gender: null },
      { id: 'hp|基础|传染病4项',       parent: '基础健康检查', label: '传染病4项',       gender: null },
    ],
  },
];
