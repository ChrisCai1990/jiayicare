...
test('order creation time recovers earlier untagged customer messages when prompt is unavailable', () => {
  assert.deepEqual(orderConversationMessages([
    { _id: 'old', createdAt: '2026-09-14T01:00:00Z' },
    { _id: 'customer', createdAt: '2026-09-14T02:01:00Z', type: 'user' },
    { _id: 'staff', createdAt: '2026-09-14T02:02:00Z', action: { orderId: 'order-a' } },
    { _id: 'other', createdAt: '2026-09-14T03:00:00Z', action: { type: 'order_planner_confirmation', orderId: 'order-b' } },
