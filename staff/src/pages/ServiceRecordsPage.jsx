...
const TYPE_COLOR = {
  disease_mgmt:'#e74c3c', nutrition:'#27ae60', medical_visit:'#0077B6', routine:'#D97706', stage_assessment:'#155E48', phase_assessment:'#155E48',
          ...
          <div className="modal" style={{ maxWidth: 600, width: '96%' }} onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-body" style={{ display: 'grid', gap: 12 }}>
              ...
              {/* 就医协助方案推送后自动生成的记录（无result），提示去会员详情页用"补充记录"追加就医结果——
                  与日常随访/健康顾问跟进/营养干预统一走同一套追加机制，不单独另造一套编辑覆盖的交互
