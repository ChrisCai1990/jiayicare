...
import { resolveApiBase } from './utils/isolatedApiBase.mjs'
const BASE = resolveApiBase(import.meta.env)
...
export const staffAPI = {
  ...
  updateDiseaseCourseEntry: (id, recordId, entryId, d) => req(`/staff/patients/${id}/disease-records/${recordId}/course-entries/${entryId}`, { method: 'PUT', body: JSON.stringify(d) }),
  ...
  rescheduleExpertAppointment: (id, data) => req(`/staff/followups/${id}/expert-appointment/reschedule`, { method: 'POST', body: JSON.stringify(data) }),
  saveFollowUpProgress: (id, d) => req(`/staff/followups/${id}/progress`, { method: 'POST', body: JSON.stringify(d) }),
  reviewFollowUpOutcome: (id, d) => req(`/staff/followups/${id}/outcome-review`, { method: 'POST', body: JSON.stringify(d) }),
  ...
  getAnnualDispatch: id => req(`/staff/followups/${id}/annual-dispatch`),
  annualDispatch: (id, data) => req(`/staff/followups/${id}/annual-dispatch`, { method: 'POST', body: JSON.stringify(data) }),
  annualDispatchResult: (id, data) => req(`/staff/followups/${id}/annual-dispatch-result`, { method: 'POST', body: JSON.stringify(data) }),
  annualDispatchReview: (id, data) => req(`/staff/followups/${id}/annual-dispatch-review`, { method: 'POST', body: JSON.stringify(data) }),
  getOnsiteBookings: id => req(`/staff/followups/${id}/onsite-bookings`),
  saveOnsiteBooking: (id, data) => req(`/staff/followups/${id}/onsite-bookings`, { method: 'POST', body: JSON.stringify(data) }),
  ...
  reviewCheckupPreparationAddons: (id, data) => req(`/staff/followups/${id}/checkup-preparation/addons/review`, { method: 'POST', body: JSON.stringify(data) }),
  recoverCheckupPreparationAddons: (id, data) => req(`/staff/followups/${id}/checkup-preparation/addons/recover`, { method: 'POST', body: JSON.stringify(data) }),
  ...
  addMonthlyReviewContribution: (reviewId, data) => req(`/staff/monthly-service-reviews/${reviewId}/contributions`, { method: 'POST', body: JSON.stringify(data) }),
  confirmMonthlyServiceReview: (reviewId, data) => req(`/staff/monthly-service-reviews/${reviewId}/confirm`, { method: 'POST', body: JSON.stringify(data) }),
  addMonthlyReviewCorrection: (reviewId, data) => req(`/staff/monthly-service-reviews/${reviewId}/corrections`, { method: 'POST', body: JSON.stringify(data) }),
  ...
  submitSupplyIntake:   (planId, data) => req(`/staff/supply-plans/${planId}/intake`, { method: 'PATCH', body: JSON.stringify(data) }),
  generateSupplyRiskDraft: (planId) => req(`/staff/supply-plans/${planId}/ai-risk-draft`, { method: 'POST' }),
  reviewSupplyRisk:     (planId, data) => req(`/staff/supply-plans/${planId}/risk-review`, { method: 'PATCH', body: JSON.stringify(data) }),
  generateSupplyArrangementDraft: (planId) => req(`/staff/supply-plans/${planId}/ai-arrangement-draft`, { method: 'POST' }),
  confirmSupplyArrangement: (planId, data) => req(`/staff/supply-plans/${planId}/arrangement`, { method: 'PATCH', body: JSON.stringify(data) }),
  ...
  getMedicationProxyDefaults: (id, medicationId = '') => req(`/staff/patients/${id}/medication-proxy/defaults${medicationId ? `?medicationId=${encodeURIComponent(medicationId)}` : ''}`),
  ...
  generateAIAnnualCheckupPlan: (id, templateId, goal, productId, desiredServiceDate, serviceRequirements) => req(`/staff/patients/${id}/ai-annual-checkup-plan`, { method: 'POST', body: JSON.stringify({ templateId, goal, productId, desiredServiceDate, serviceRequirements }) }),
