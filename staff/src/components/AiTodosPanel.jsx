...
const TYPE_CONFIG = {
  ...
  report_familydoctor_review: { icon: '📋', label: '专项筛查数据待复核', color: '#7C3AED', priority: 2 },
  archive_review:  { icon: '🗂️', label: '健康档案问卷待审核', color: '#0077B6', priority: 3 },
  summary_review:  { icon: '🩺', label: '健康信息整理待核对', color: '#22A06B', priority: 2 },
  screening_summary_review: { icon: '📑', label: '年度专项筛查小结待审核', color: '#7C3AED', priority: 2 },
  summary_generate: { icon: '🩺', label: '5维健康信息整理待生成', color: '#22A06B', priority: 2 },
  case_review: { icon: '🧠', label: 'AI辅助研判待确认', color: '#7C3AED', priority: 2 },
  annual_plan_review: { icon: '🗓️', label: 'AI年度管理方案待审核', color: '#1E6B50', priority: 2 },
  annual_plan_customer_changes: { icon: '↩️', label: '年度管理方案待调整', color: '#DC3545', priority: 1 },
  ...
  medical_assist_plan_changes: { icon: '↩️', label: '就医协助方案待调整', color: '#DC3545', priority: 1 },
