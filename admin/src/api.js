...
export const adminAPI = {
  ...
  saveInsuranceEnrollments: (enterpriseId, policyId, enrollments, replace = true) => req(`/enterprises/${enterpriseId}/insurance-policies/${policyId}/enrollments`, { method: 'PUT', body: JSON.stringify({ enrollments, replace }) }),
  ...
  getHealthAssistantConfig: () => req('/system-config/health-assistant'),
  updateHealthAssistantConfig: (data) => req('/system-config/health-assistant', { method: 'PUT', body: JSON.stringify(data) }),
  getSupplyWorkflowConfig: () => req('/system-config/supply-workflow'),
  updateSupplyWorkflowConfig: (data) => req('/system-config/supply-workflow', { method: 'PUT', body: JSON.stringify(data) }),
  getReviewExperienceConfig: () => req('/system-config/review-experience'),
