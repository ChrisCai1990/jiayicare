...
export default function SupplyWorkflowConfigPage() {
  ...
  return <div className="page" style={{ maxWidth: 1220, margin: '0 auto' }}>
    ...
    <h2 style={{ fontSize: 18, margin: '28px 0 12px' }}>产品与流程关联</h2><div style={card}>
      <div style={{ display: 'flex', justifyContent: 'space-between', gap: 12, marginBottom: 14 }}><div style={{ color: '#6B7D74', fontSize: 13 }}>主流程和随访方案均为独立可选项。修改会自动保存在当前浏览器草稿中；完成后点击页面上方“保存全部关联”写入系统。</div><input className="form-input" style={{ width: 220 }} value={search} onChange={e => setSearch(e.target.value)} placeholder="搜索产品" /></div>
