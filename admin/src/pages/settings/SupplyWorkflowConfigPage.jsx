...
const PRODUCT_STAGE_TEXT = {
  ...
  '门诊一站式服务': '资料收集 → 就医规划 → 首次门诊开检查单 → 预约检查 → 检查准备 → 检查日专家门诊 → 陪诊 → 资料归档 → 按医嘱复诊',
}
