...
const CONTENT = {
  terms: {
    ...
    sections: [
      {
        heading: '1. 接受条款',
        body: '欢迎使用嘉医管家（以下简称"本应用"）。您在使用本应用前，请仔细阅读本用户协议。一旦您使用本应用，即表示您已阅读并同意遵守本协议的全部条款。',
      },
      {
        heading: '2. 服务内容',
        body: '本应用提供健康数据管理、用药提醒、随访任务、AI 健康咨询及医生/健管师沟通等功能。所有服务内容可能因地区、套餐类型不同而有所差异。',
      },
      {
        heading: '3. 用户注册与账号安全',
  ...
  disclaimer: {
    ...
    sections: [
      {
        heading: '1. 医疗信息免责',
        body: '本应用提供的所有健康信息、AI 助手回复及健康建议均仅供参考，不构成医疗诊断、治疗建议或处方。任何健康问题请以执业医师的专业判断为准。',
      },
      {
        heading: '2. AI 健康助手限制',
        body: 'AI 健康助手基于通用医学知识库，无法替代面诊。其回复不能作为诊断依据，不能替代专业医疗建议。如您有紧急健康状况，请立即拨打 120 或前往医院急诊。',
      },
      {
        heading: '3. 数据准确性',
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>嘉医管家 · 上海嘉医汇科技有限公司</Text>
          <Text style={styles.footerText}>客服电话：400-888-8888</Text>
        </View>
