...
const TEMPLATE_NORMALIZATION = {
  ...
  '门诊一站式服务': {
    ...
    applicableScenario: '主要面向单次购买完整门诊服务的客户：尚需收集资料并由健康顾问评估确定医院、专家，随后完成首次代诊开单、检查预约、检查日专家门诊和陪诊。年度会员的健康顾问评估属于会员服务，通常按实际需要另选代办、代诊或陪诊，不重复购买本服务。',
    standardSteps: '健康规划师建立服务并全程督办\n健管专员收集并核对病历、既往报告、用药信息和本次诉求，将客户提供的报告上传归档并审核资料完整性\n健康顾问评估分析资料，确定医院、科室、专家、预计检查项目及需要指定专家的检查\n健管专员按评估结论一次性完成代诊开单、特殊检查及检查后专家门诊预约\n健康规划师根据预约结果分别安排首次代诊与检查日陪诊就医专员\n就医专员完成首次代诊，按医嘱取得检查单和门诊病历\n就医专员陪同完成检查及专家门诊，并上传归档病历、检查单和已取得结果',
