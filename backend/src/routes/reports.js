...
③ "异常结果汇总" / "异常结果及建议" / "体检结果汇总" / "综合小结" / "主要阳性结果" 页
...
【3. 内科/外科/耳鼻喉/视力检查/眼压检查/眼科检查/裂隙灯检查/双眼眼底照相 及其他一般体格检查项目】
→ itemType="imaging"，每项单独一条
→ name = 科室或检查名称，与报告原文完全一致（如"内科"/"外科"/"耳鼻喉"/"视力检查"/"眼压检查"/"眼科检查"/"裂隙灯检查"/"双眼眼底照相"）
...
→ 【orderName 必填】：
  ...
  - 常见映射：丙氨酸氨基转移酶/白蛋白/总蛋白/总胆红素 → "肝功能"；
    肌酐/血肌酐/尿素/尿素氮/尿酸/肾小球滤过率/eGFR/胱抑素C（无论报告标题是"肾功能"/"肾功能四项"/"肾功能+尿酸"还是其他变体，一律 orderName="肾功能"）→ "肾功能"；
