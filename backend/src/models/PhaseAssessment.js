...
const phaseAssessmentSchema = new mongoose.Schema({
  ...
  assessmentDomain: { type: String, enum: ['comprehensive', 'multidisciplinary', 'nutrition', 'exercise', 'tcm'] },
  primaryReviewRole: { type: String, enum: ['familyDoctor', 'nutritionist', 'rehabSpecialist', 'tcmDoctor'] },
  professionalReview: { type: mongoose.Schema.Types.Mixed, default: null },
