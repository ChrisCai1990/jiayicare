...
const followUpSchema = new mongoose.Schema({
  ...
  activationEvent: { type: String, enum: ['', 'customer_plan_confirmed', 'booking_completed', 'onsite_completed', 'executor_completed', 'checkup_report_uploaded', 'previous_stage_approved'], default: '' },
