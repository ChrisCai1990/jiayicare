...
const followUpSchema = new mongoose.Schema({
  ...
  sourceType: { type: String, enum: ['scheduled', 'ai_review', 'health_plan', 'insurance_service', 'annual_coordination', 'annual_service', 'annual_preparation', 'medication_reminder', 'supply_reminder', 'order', 'symptom', null], default: null },
