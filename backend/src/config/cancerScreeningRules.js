...
// 还判断"该做的筛查做了没"，没做的主动提示补做。规则由医学口径固化，AI 只负责匹配会员报告 + 措辞。
//
// 覆盖度模型（每个肿瘤的筛查项分三种角色）：
...
const CANCER_RULES = {
  ...
  endometrial: {
    // 与女性十大肿瘤目录统一使用“子宫体癌”；体检机构常把经阴道妇科超声简写为
    // “子宫附件”“子宫、附件彩超”，这些名称按业务口径均视为本项基础影像覆盖。
    label: '子宫体癌', gender: 'F',
    gold:      [{ key: 'tv_us', label: '子宫附件/经阴道超声', matchNames: ['经阴道超声', '阴道超声', '阴道彩超', '妇科超声', '子宫附件', '附件超声', '子宫彩超', '盆腔超声'] }],
    alternate: [], adjunct: [{ key: 'ca125_endo', label: 'CA125', matchNames: ['CA125', 'CA-125', '糖链抗原125'] }],
    note: '体检机构表述为子宫附件、妇科、经阴道或盆腔超声时均记为基础影像覆盖；绝经后异常出血仍需重点排查，经阴道超声可观察内膜厚度。',
  },
};
