...
const ARCHIVE_FIELDS = [
  ...
  { path: 'lifestyle_data.breakfastDetail',      label: '早餐就餐方式',   group: '膳食调查', type: 'enum', options: ['居家', '饭店', '外卖', '在校', '少吃', '不吃'] },
  ...
  { path: 'lifestyle_data.lunchDetail',          label: '午餐就餐方式',   group: '膳食调查', type: 'enum', options: ['居家', '饭店', '外卖', '在校', '少吃', '不吃'] },
  ...
  { path: 'lifestyle_data.dinnerDetail',         label: '晚餐就餐方式',   group: '膳食调查', type: 'enum', options: ['居家', '饭店', '外卖', '在校', '少吃', '不吃'] },
  ...
  // 食物摄入量
  { path: 'lifestyle_data.dailyStaple',      label: '每日主食摄入量', group: '膳食调查', type: 'enum', options: ['约250克', '100-200克', '250-400克', '400克以上', '几乎不吃'] },
  { path: 'lifestyle_data.dailyVegetables',  label: '每日蔬菜摄入量', group: '膳食调查', type: 'enum', options: ['500克及以上', '300-500克', '300克以内', '几乎不吃'] },
  { path: 'lifestyle_data.dailyMeat',        label: '每日荤菜摄入量', group: '膳食调查', type: 'enum', options: ['80克以内', '80-150克', '150-200克', '200-250克', '250克以上', '几乎不吃'] },
  { path: 'lifestyle_data.fruitFrequency',   label: '吃水果频次',     group: '膳食调查', type: 'enum', options: ['1-2天/周', '3天/周及以上', '每天吃', '几乎不吃'] },
  { path: 'lifestyle_data.fruitAmount',      label: '水果摄入量',     group: '膳食调查', type: 'enum', options: ['200克以内', '200-350克', '350克以上'] },
  { path: 'lifestyle_data.eggFrequency',     label: '鸡蛋摄入频次',   group: '膳食调查', type: 'enum', options: ['1-3天/周', '3-5天/周', '每天都吃', '不吃'] },
  ...
  { path: 'lifestyle_data.dairyRemark',      label: '奶制品备注',     group: '膳食调查', type: 'text' },
  { path: 'lifestyle_data.nutFrequency',     label: '坚果摄入频次',   group: '膳食调查', type: 'enum', options: ['一周2-3天', '一周3-5天', '每天吃', '几乎不吃'] },
  ...
  { path: 'lifestyle_data.foodAllergensOtherDesc', label: '食物过敏源-其它说明', group: '膳食调查', type: 'text' },
  { path: 'lifestyle_data.glutenAllergy',        label: '麸质过敏',         group: '膳食调查', type: 'enum', options: ['是', '否', '不清楚'] },
