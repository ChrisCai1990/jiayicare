...
const NODES = [
  ...
  { id: 'other|激素类|甲状腺功能', category: 'other', categoryKey: 'other', parent: '激素类', label: '甲状腺功能', itemType: 'lab', gender: null,
    aliases: ['甲功', '甲功三项', '甲功五项', '甲功七项', '甲状腺功能3项', '甲状腺功能5项', '甲状腺功能7项', '甲状腺功能五项', 'TSH', 'FT3', 'FT4', 'T3', 'T4', '促甲状腺激素', '游离三碘甲状腺原氨酸', '游离甲状腺素', '三碘甲状腺原氨酸', '三碘甲腺原氨酸', '游离三碘甲腺原氨酸', '甲状腺素', 'TPOAb', 'TgAb', 'TRAb', '抗甲状腺过氧化物酶抗体', '促甲状腺素受体抗体', '抗甲状腺球蛋白抗体', '甲状腺过氧化物酶抗体'] },
