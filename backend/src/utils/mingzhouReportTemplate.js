...
本页是多部位超声检查。必须按器官分成独立记录，name 统一为“甲状腺超声、颈动脉超声、肝脏超声、胆囊超声、胰腺超声、脾脏超声、双肾超声、双侧输尿管膀胱超声、前列腺超声、眼部超声”中的对应项。每条 findings 只允许放对应器官的原文；不得把肾脏所见写到肝脏，不得把甲状腺结论写到其他器官。诊断意见无法唯一归属时留空并待人工核对，禁止顺移。`;
  return '';
}
