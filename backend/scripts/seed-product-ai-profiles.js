...
const PROFILES = {
  ...
  '门诊一站式服务': profile(['资料收集与健康顾问评估', '首次代诊开单与检查预约', '检查日专家门诊及陪诊'], ['需要一次性完成评估、开单、检查和专家门诊闭环的单次服务客户'], ['主要就医诉求是什么？', '现有病历、报告和用药资料是否齐全？', '是否理解年度会员通常只需按需选择代办、代诊或陪诊？'], { notSuitableFor: ['仅需健康顾问评估的年度会员', '已有明确检查单且只需代约检查', '仅需单次代诊或陪诊'] }),
