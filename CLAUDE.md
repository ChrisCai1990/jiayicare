> 2026-09-23回退全流程cbc0987a已部署：四端生产构建、版本、健康与Staff/Admin新资源核验通过；仅原金娟试点、无迁移。现有单项协助需明确点击“进入完整就医流程”接入，之后回退直返和留痕生效，不覆盖年度方案。Admin新增质量复核。真实业务未代操作，详见docs/CARE_FLOW_RETURNS_20260923.md。
