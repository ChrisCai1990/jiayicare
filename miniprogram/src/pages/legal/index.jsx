...
const CONTENT = {
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: '3. 敏感个人信息', body: '体检报告、健康档案、用药记录及聊天中涉及健康状况的信息属于敏感个人信息。我们将在取得单独同意后，按照明确目的和最小必要范围处理；拒绝非必要处理不影响您使用其他基础功能。' },
      ...
      { heading: '7. 您的权利与账号注销', body: '您有权访问、更正、复制、删除个人信息，撤回同意并申请注销账号。可通过“我的—帮助与反馈”提交申请；我们核验身份后依法处理。紧急投诉可联系客服：17742039618。' },
