...
const CONTENT = {
  terms: {
    ...
    sections: [
      ...
      { heading: '2. 服务内容', body: '本应用提供健康档案整理、体检信息整理、健康数据趋势展示、生活方式管理、健康提醒、服务需求梳理及就医协助等非医疗健康管理功能。所有服务内容可能因地区、套餐类型不同而有所差异。' },
  ...
  service: {
    title: '健康管理服务说明',
    sections: [
      { heading: '1. 服务性质', body: '嘉医汇是非医疗健康管理服务平台，提供健康档案整理、体检信息整理、健康数据趋势展示、生活方式管理、健康提醒、复查提醒、服务规划及就医协助。平台不属于医疗机构，不开展互联网诊疗。' },
      ...
      { heading: '4. 报告与数据', body: '系统仅对会员上传报告中的文字、指标和参考范围进行信息提取、分类及趋势展示，不作疾病诊断。原始报告及医疗机构出具的正式结论具有优先效力。' },
      { heading: '5. 用药记录', body: '用药功能仅用于会员自行记录和提醒，不提供处方、用药推荐或药物剂量调整。停药、换药或调整剂量前应咨询开具处方的医师。' },
      { heading: '6. 就医提示', body: '出现身体不适、指标明显异常或持续加重时，请及时前往正规医疗机构；出现胸痛、呼吸困难、意识障碍等紧急情况，请立即拨打120。' },
      { heading: '7. 会员选择', body: '平台可基于会员表达的目标推荐健康管理服务，但会说明推荐理由，是否购买由会员自主决定，平台不承诺治疗效果。' },
    ],
  },
  disclaimer: {
    title: '免责声明',
